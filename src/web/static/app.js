(function () {
  ...
  const applicationViews = [
    { id: "overview", label: "Overview", icon: "/static/assets/nav-overview.svg", eyebrow: "Estate command center", title: "Storage intelligence", subtitle: "Capacity, Cost, Risk, Impact, And Defensible Savings." },
  ...
  function App() {
    ...
    useEffect(() => {
      ...
      document.title = translateText("Storage Intelligence", language);
      setQuestion((current) =>
      ...
      e("aside", { className: "sidebar" },
        e("div", { className: "brand" },
          ...
          e("div", { className: "brand-copy" },
            ...
            e("div", { className: "product-name" }, "Storage Intelligence")
          )
        ),
