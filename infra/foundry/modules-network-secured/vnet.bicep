...
var functionsSubnet = empty(functionsSubnetPrefix) ? cidrSubnet(vnetAddress, 24, 3) : functionsSubnetPrefix
...
output functionsSubnetId string = '${virtualNetwork.id}/subnets/${functionsSubnetName}'
