...
@description('Address prefix for the Flex Functions subnet')
...
module existingVNet 'existing-vnet.bicep' = if (useExistingVnet) {
  ...
  params: {
    ...
    functionsSubnetExists: functionsSubnetExists
  }
}
...
output functionsSubnetId string = useExistingVnet ? existingVNet!.outputs.functionsSubnetId : newVNet!.outputs.functionsSubnetId
