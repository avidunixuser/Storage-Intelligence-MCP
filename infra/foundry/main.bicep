...
@description('Flex Functions subnet name.')
...
output aiProjectEndpoint string = '${aiAccount.outputs.accountTarget}api/projects/${aiProject.outputs.projectName}'
...
output functionsSubnetId string = vnet.outputs.functionsSubnetId
output foundryStorageName string = aiDependencies.outputs.azureStorageName
...
output logAnalyticsId string = applicationInsights.outputs.logAnalyticsId
